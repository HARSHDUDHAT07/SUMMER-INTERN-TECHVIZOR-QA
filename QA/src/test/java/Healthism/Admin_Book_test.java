...
public class Admin_Book_test {
	
	public static ExtentTest test;
	public static ExtentReports extent;
	public static ExtentSparkReporter spark;
	
	Logger log = LogManager.getLogger("Admin_Book_test");
...
//	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	...
	public void login() throws Exception {
		...
		test.log(Status.INFO, "MobileNo Entered SucessFully");
	...
	public void add_lab() throws Exception {
		...
		test.log(Status.INFO, "Book Test open SucessFully");
		...
		test.log(Status.INFO, "Direct_call open SucessFully");
		...
		test.log(Status.INFO, "Continue_Button Click SucessFully");
		...
		test.log(Status.INFO, "lab_name Write SucessFully");
		...
		test.log(Status.INFO, "Select_lab Perform SuccessFully");
		log.info("Lab Details are Enetered SuccessFully");
		test.log(Status.INFO, "Lab Details are Enetered SuccessFully");
		...
		test.log(Status.INFO, "Add_Test perform Successfully");
		Thread.sleep(3000);
...
//		Next_step_1.click();
		...
		test.log(Status.INFO, "Type selection perform Successfully");
		...
		test.log(Status.INFO, "Collection Select SuccessFully");
		log.info("Collection and Details are Filled Successfully");
		test.log(Status.INFO, "Collection and Details are Filled Successfully");
		Thread.sleep(1000);
		ac.sendKeys(Keys.PAGE_DOWN).build().perform();
		...
		test.log(Status.INFO, "Slot Selected Successfully");
		...
		test.log(Status.INFO, "Select Patient Perform Successfully");
		...
		test.log(Status.INFO, "Select Address perform Successfully");
		Thread.sleep(2000);
		...
		test.log(Status.INFO, "offline Payment Perform SuccessFully");
		Thread.sleep(2000);
		ac.sendKeys(Keys.PAGE_DOWN).build().perform();
		Thread.sleep(1500);
		log.info("Order Details Verify");
		test.log(Status.INFO, "Order Details Verify");
		log.info("Order Status Verify");
		test.log(Status.INFO, "Order Status Verify");
		...
		test.log(Status.INFO, "Go to Home Successfully Executed");
	}
