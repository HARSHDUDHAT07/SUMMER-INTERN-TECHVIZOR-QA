...
public class Lab_BookTest {

	public static void main(String[] args) throws Exception {
		// TODO Auto-generated method stub
		Logger log = LogManager.getLogger("Lab_BookTest");
		...
		Thread.sleep(1000);
		WebElement select_Lab = driver.findElement(By.xpath("//a[@data-parent-id='1']"));
		select_Lab.click();
		Thread.sleep(1000);
...
//		Next_step_1.click();
		...
		//slect patienbegin
		Thread.sleep(2000);
		WebElement slot = driver.findElement(By.xpath("//a[@data-slot-id='419']"));
		slot.click();
		Thread.sleep(1000);
		ac.sendKeys(Keys.PAGE_UP).build().perform();
		Thread.sleep(2000);
		...
		WebElement online = driver.findElement(By.xpath("//a[@data-payment-id='2']"));
		online.click();
		log.info("online Payment Perform SuccessFully");
		Thread.sleep(2000);
		ac.sendKeys(Keys.PAGE_DOWN).build().perform();
		Thread.sleep(1500);
